...
<body>
	<div class="layui-layout layui-layout-admin" style="border-bottom: solid 5px #01AAED;">
		<div class="layui-header header header-demo">
			<div class="layui-main">
				<div class="admin-login-box">
                    ...
                    <div class="admin-side-full"  style="background-color: #01AAED;">
		...
		if("<%=userNm%>" == "") {
			window.location.href = "operInf/login";
		}
		var navs;
		$.ajax({
			url : '<%=request.getContextPath()%>/menuInf/getTreeByRole',
			dataType : 'json',
			async: false,
				...
				$('#sysout').on('click', function() {
					layer.confirm('是否退出系统？', {
					  btn: ['退出','取消'] //按钮
						...
						location.href = '${pageContext.request.contextPath}/operInf/logout';
					}, function(){
