...
<script>
    layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element'], function () {
        ...
        table.render({
            elem: '#table',//table id
            url: '<%=request.getContextPath()%>/student/datagrid',
            method: 'POST', //方式
            page: true,//是否开启分页
            ...
            cols: [[ //标题栏
                ...
                {field: 'sexNm', title: '性别', align: 'center', templet: '#sexTpl'},
                {field: 'stateNm', title: '状态', align: 'center', templet: '#stateTpl'},
                {field: 'dateBirth', title: '出生年月', align: 'center', sort: true},
        ...
        function openUpdate(data) {
            layer.open({
                ...
                area: ['100%', '100%'],
                boolean: true,
                content: ['StudentEdit.jsp?obj=' + encodeURIComponent(JSON.stringify(data)), 'yes'], //iframe的url，no代表不显示滚动条
                success: function (layero, lockIndex) {
            ...
            layer.open({
                ...
                , success: function (layero) {
                    ...
                    btn.find('.layui-layer-btn0').on('click', function () {
                        ...
                        $.ajax({
                            url: '<%=request.getContextPath()%>/student/remove',
                            data: {
                                uuid: ids
                            },
...
<script type="text/html" id="sexTpl">
    <span class="layui-badge  {{ d.sex == 0 ? 'layui-bg-green' : '' }} ">{{d.sexNm}}</span>
</script>
</body>
</html>
