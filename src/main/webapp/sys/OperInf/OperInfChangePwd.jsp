...
<form class="layui-form"  style="margin-top: 20px;" method="post" action="">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="password" name="operPwd" id="operPwd" lay-verify="required" placeholder="请输入" autocomplete="off" width="200px" class="layui-input" />
    </div>
  </div>
  <div class="layui-form-item">
    <label class="layui-form-label">确认密码</label>
    <div class="layui-input-block">
      <input type="password" name="reOperPwd" id="reOperPwd" lay-verify="required" placeholder="请输入" autocomplete="off" width="200px" class="layui-input" />
    </div>
  </div>
   <!-- 按钮组 -->
   <div class="layui-input-block">
...
layui.use(['form', 'layedit', 'laydate','jquery'], function(){
  ...
  form.on('submit(btnSubmit)', function(data){
    ...
    $.ajax({
			url : '<%=request.getContextPath()%>/operInf/changepwd',
			data :data.field,
