...
<form name="form" class="layui-form" style="margin-top: 20px;" method="post" action="">
   <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" name="dictTypeCd"  lay-verify="required" maxlength="36" placeholder="请输入" autocomplete="off" class="layui-input" />
    </div>
  </div>
   <div class="layui-form-item">
...
layui.use(['form', 'layedit', 'laydate','jquery'], function(){
  ...
  form.on('submit(btnSubmit)', function(data){
    ...
    $.ajax({
			url : '<%=request.getContextPath()%>/dictTp/add',
			data :data.field,
