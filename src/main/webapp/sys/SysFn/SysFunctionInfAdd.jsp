   ...
   <div class="layui-form-item">
    ...
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        ...
        <input type="text" name="menuNm" id="menuNm" lay-verify="required"  readOnly="readOnly" placeholder="请输入"  autocomplete="off" class="layui-input">
      </div>    	 
      <div class="layui-input-inline">
...
<script>
 layui.use(['form', 'layedit', 'laydate','jquery'], function(){
  ...
  form.on('submit(btnSubmit)', function(data){
    ...
    $.ajax({
			url : '<%=request.getContextPath()%>/sysFunctionInf/add',
			data :data.field,
